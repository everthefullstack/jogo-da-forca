...
from controller import login_controller, cadastro_controller, cria_banco_controller, admin_manter_usuario_controller, admin_manter_categoria_controller, admin_manter_palavra_controller
